  ...
  <div class="login-left">
    <div class="signup">
      <form action="javascript:validateForm()" method="post">
        ...
        <div id="bad-icon-user" class="bad-icon hidden"><i class="fas fa-times"></i></div>

        <div class="input-icon"><i class="fas fa-envelope"></i></div>
        <input type="text" id="email" name="email" placeholder="Email Address">
        <div id="bad-icon-email" class="bad-icon hidden"><i class="fas fa-times"></i></div>

        <div class="input-icon"><i class="fas fa-lock"></i></div>
        <input type="password" id="password" name="password" placeholder="Enter Password">
        <div id="bad-icon-pass" class="bad-icon hidden"><i class="fas fa-times"></i></div>

        <div class="input-icon"><i class="fas fa-lock"></i></div>
        <input type="password" id="confirmpassword" name="confirmpassword" placeholder="Confirm Password">
        <div id="bad-icon-confirm" class="bad-icon hidden"><i class="fas fa-times"></i></div>

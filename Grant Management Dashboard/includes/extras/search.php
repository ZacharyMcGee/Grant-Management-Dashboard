...
$sql = "SELECT id, name, bp, dc_award, idc_award, agency, jsondata, creation_date FROM grants WHERE userid=" . $_SESSION['id'] . " AND name like '%$search%' OR bp like '%$search%'";
...
{
    echo "Your search \"" . $search . "\" returned 0 results!";
}
